...
// import { useEffect, useState } from "react";
// import { useParams, useRouter } from "next/navigation";
// import { getCoverLetter, sendEmail } from "@/actions/coverletter"; // server actions
// import {
//   ArrowLeft,
//   Mail,
//   Send,
...
// export default function SendEmailPage({ accessToken }) {
//   const { id } = useParams();
//   const router = useRouter();
...
//     if (!accessToken) {
//       alert("You must sign in with Gmail to send email.");
//       return;
//     }
...
//         subject,
//         message,
//         accessToken, // Pass the user's Gmail OAuth token
//       });
...
//               </h1>
//               <p className="text-gray-600 mt-2 text-lg">
//                 Send your cover letter via your Gmail account
//               </p>
//             </div>
//           </div>
//         </div>
